        ...
        <section className="py-12 bg-orange-50 border-y border-orange-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center space-x-2 bg-orange-100 px-4 py-2 rounded-full border border-orange-300 mb-4">
              ...
              <span className="font-bold text-orange-600">SHARE FEEDBACK</span>
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Help Us Improve
            </h3>
            <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
              Your feedback is invaluable. Found a bug? Have a feature suggestion?
              We want to hear from you!
            </p>
            <a
              href="mailto:ebenezer.miezah@mcgill.ca?subject=Green%20Means%20Go%20-%20Feedback"
